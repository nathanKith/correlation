...
print("Введите интересущий тикер номер 1:")
ticker1 = input()
print('Введите интересущий тикер номер 2:')
ticker2 = input()
...
print('Среднее значение по первой выборке', np.mean(data['change1']))
print('Среднее значение по второй выборке', np.mean(data['change2']))
...
print('Значение корреляции по Пирсону', pearson_def(data['sample1'], data['sample2']))
